...
public class SolidGUI extends javax.swing.JFrame
{
    ...
    private WordPairControlInterface wordPairInterface;

    public SolidGUI()
    {
        wordPairInterface = new Controller();
        initComponents();
        wordPairInterface.load("Ordpar.txt");
    }
    ...
    private void initComponents() {
        ...
        jTabbedPane3.addTab("Dictonary", jPanel2);
    ...
    {//GEN-HEADEREND:event_jButton3ActionPerformed
        ...
        wordPairInterface.add(danishWord, englishWord);
        wordPairInterface.load("Ordpar.txt");
        
        jLabel5.setText("WordPair has been saved");
        jTextField3.setText("");
        jTextField4.setText("");
    ...
    public static void main(String args[])
    {
        ...
        {
            java.util.logging.Logger.getLogger(SolidGUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
